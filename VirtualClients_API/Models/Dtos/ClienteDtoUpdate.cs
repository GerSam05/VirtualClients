...
namespace VirtualClients_API.Models.Dtos
{
    public class ClienteDtoUpdate
    {
        ...
        [RegularExpression(@"^[a-zA-ZÁÉÍÓÚáéíóú ]+$", ErrorMessage = "El Campo Nombre sólo admite letras")]
        ...
        [RegularExpression(@"^[a-zA-ZÁÉÍÓÚáéíóú ]+$", ErrorMessage = "El Campo Apellido sólo admite letras")]
        public string Apellido { get; set; }

        [Required]
        [Range(1, 11, ErrorMessage = "El campo Estatus requerido debe ser mayor que cero (0) y menor o igual a diez (10)")]
